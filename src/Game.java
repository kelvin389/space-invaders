...
public class Game extends Canvas {
        ...
        private long lastJump = 0; //time of the last jump
        private boolean jumping = false; //true if jumping
        ...
        private double jumpSpeed = 50; // vertical velocity
    	...
    	private void initEntities() {
              ...
              ship = new ShipEntity(this, "sprites/ship2.gif", 50, 850);
              entities.add(ship);
	...
	public void gameLoop() {
          ...
          while (gameRunning) {
           ...
           if (waitingForKeyPress) {
            ...
            if (upPressed) {
            	lastFire = System.currentTimeMillis();
            	//ensure 5 secs between jumps
            	if (System.currentTimeMillis() - lastJump > 5000) {
            		jumping = true;
            	}
            }
